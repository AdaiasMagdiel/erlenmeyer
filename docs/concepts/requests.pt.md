...
See [Guides → Deploying to Production](../guides/deployment.md#behind-a-reverse-proxy-trusted-ips-and-https-detection)
for the Nginx/Traefik/Caddy setups where this actually comes up.
